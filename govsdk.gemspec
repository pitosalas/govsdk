...
Gem::Specification.new do |s|
  ...
  s.files = ["README.textile", "VERSION.yml", "lib/apis", "lib/apis/generic_api.rb", "lib/apis/google_api.rb", "lib/apis/open_secrets_api.rb", "lib/apis/sunlight_api.rb", "lib/apis/vote_smart_api.rb", "lib/congress_person.rb", "lib/govsdk.rb", "lib/govsdk_base.rb", "lib/govsdkgem.rb", "lib/util.rb", "test/congressperson_test.rb", "test/google_api_test.rb", "test/govsdk_test.rb", "test/open_secrets_api_test.rb", "test/sunlight_api_test.rb", "test/test_helper.rb", "test/test_template.rb", "test/util_test.rb", "test/vote_smart_api_test.rb"]
  s.has_rdoc = true
